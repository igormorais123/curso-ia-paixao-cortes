...
## INTERVALO (10 min)
**TAREFA**: "Até amanhã, usem IA em algo real do escritório. Qualquer coisa. Tragam a experiência."

---

# DIA 2 — SÁBADO (3 horas)

## BLOCO 4: AQUECIMENTO + DOMÍNIO (70 min)
**"O momento em que você assume o controle"**

| Min | Atividade | Detalhe |
|-----|-----------|---------|
| 0-15 | Aquecimento | "O que tentaram? O que funcionou? O que falhou?" Celebrar tentativas. |
...
**Slides: 2** (fluxo visual, caso fictício)

---

## BLOCO 5: SEGURANÇA REAL (35 min)
...
**Slides: 1** (template do compromisso)
...
## DIA 2 — SÁBADO (3h = 180 min)

| Bloco | Início | Fim | Duração |
|-------|--------|-----|---------|
| 4. Domínio | 0:00 | 1:10 | 70 min |
| Intervalo | 1:10 | 1:20 | 10 min |
| 5. Segurança | 1:20 | 1:55 | 35 min |
| 6. Horizontes | 1:55 | 2:10 | 15 min |
| 7. Compromisso | 2:10 | 2:40 | 30 min |
| Buffer | 2:40 | 3:00 | 20 min |
| **Total** | | | **180 min** |
